const EMPLOYEES = [
  {
    ...
    featured: true,
    jobDescription:
      'El CEO, esta encargado de dirigir la empresa para conseguir los objetivos alineados con las estrategias de la ' +
  ...
  },
  {
    ...
    featured: false,
    jobDescription:
      'El CTO, tiene la function de garantizar la calidad de los productos de software cuidando que los recursos utiliados ' +
  ...
  },
  {
    ...
    featured: false,
    jobDescription:
      'Tiene la function de dirigir los projectos de software garantizando que se utilice adecuadamente la major ' +
  ...
  },
  {
    ...
    featured: false,
    jobDescription:
      'Debe garantizar que la experiencia del usuario al estar frente al producto de software sea lo mas agradable ' +
